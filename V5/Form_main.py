...
#导入自动程序
import zdlz1, zdlz3, zdlz4, zdlz5, zdlz6
...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.Button_savechoose.place(relx=0.382, rely=0.495, relwidth=0.174, relheight=0.103)
        ...
        if self.select():
            try:
                ...
                if self.Check_zdlz4Var.get() == '1': 
                    ...
                    if self.config['QQ_path']['QQ'] == '': raise
                    infor_zdlz4, is_success_zdlz4 = zdlz4.main(max_cs, is_head, self.offset_)
                ...
                if self.Check_zdlz5Var.get() == '1': 
                    ...
                    if self.config['QQ_path']['QQ'] == '': raise
                    infor_zdlz5, is_success_zdlz5 = zdlz5.main(max_cs, is_head, self.offset_)
                ...
                if self.Check_zdlz6Var.get() == '1': 
                    ...
                    if self.config['QQ_path']['QQ'] == '': raise
                    infor_zdlz6, is_success_zdlz6 = zdlz6.main(is_head)
                ...
                if self.Check_zdqd1Var.get() == '1': 
                    ...
                    if self.config['path_lz']['username'] == '' or self.config['path_lz']['password'] == '': raise
                    infor_zdqd1, is_success_zdqd1 = zdqd1.main(max_cs, is_head, self.offset_)
