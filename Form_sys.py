...
def Form_sys_main():
    ...
    try:
        ...
        if not config.has_section("web"):
            ...
            config.set('web', 'zdlz1', 'http://176.26vp.com/user/order?gid=3222')
            config.set('web', 'zdlz2', 'http://www.dsw.zfanw.cn/user/shop.php?cid=25&tid=330')
            config.set('web', 'zdlz3', 'https://www.qvvvvv.com/?cid=1&tid=309')
            config.set('web', 'zdlz4', 'https://www.ieqq.net/?cid=222&tid=5584')
            config.set('web', 'zdlz5', 'http://www.dayuaa.cn/?cid=86&tid=1941')
            config.set('web', 'zdlz6', 'http://www.aizy.cc/?cid=1&tid=449')
            config.set('web', 'zdqd1', 'http://176.26vp.com/user/sign')
            config.set('web', 'zdqd2', 'http://www.dsw.zfanw.cn/user/qiandao.php')
            config.set('web', 'sgsqd1', 'http://my.4399.com/forums/mtag-78097')
            config.set('web', 'sgsqd2', 'http://my.4399.com/jifen/')
            config.set('web', 'sfycs', 'https://www.sanfengyun.com/control/#/freeServer/352133')
            config.set('web', 'sfyvh', 'https://www.sanfengyun.com/control/#/freeVhost/6482183')
            config.write(open(path_default_sys, 'r+'))
            tkinter.messagebox.showinfo('提示','默认网站配置设置成功！')
    except: tkinter.messagebox.showerror('错误','网站配置加载错误！')
