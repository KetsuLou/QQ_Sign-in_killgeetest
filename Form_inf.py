...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.Option_sgs.place(relx=0.321, rely=0.52, relwidth=0.229, relheight=0.099)
        ...
        self.Option_1and2.place(relx=0.573, rely=0.52, relwidth=0.344, relheight=0.099)
        ...
        self.Button_OK.place(relx=0.183, rely=0.669, relwidth=0.229, relheight=0.124)
        ...
        self.Button_close.place(relx=0.596, rely=0.669, relwidth=0.229, relheight=0.124)

        self.style.configure('Label_QQ.TLabel',anchor='w', font=('宋体',12))
        self.Label_QQ = Label(self.top, text='QQ：', style='Label_QQ.TLabel')
        self.Label_QQ.place(relx=0.046, rely=0.05, relwidth=0.457, relheight=0.074)
        ...
        self.Label_input1.place(relx=0.046, rely=0.198, relwidth=0.457, relheight=0.074)
        ...
        self.Label_input2.place(relx=0.046, rely=0.347, relwidth=0.457, relheight=0.074)

        self.style.configure('Button_webset.TButton',font=('宋体',9))
        self.Button_webset = Button(self.top, text='查看网站配置', command=self.Button_webset_Cmd, style='Button_webset.TButton')
        self.Button_webset.place(relx=0.321, rely=0.843, relwidth=0.34, relheight=0.093)
...
class Application(Application_ui):
    ...
    def Button_webset_Cmd(self, event=None):
